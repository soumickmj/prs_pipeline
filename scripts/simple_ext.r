...
option_list = list(
  ...
  make_option(c('-o', '--output'), action='store', type='character', help='output prefix [required]', default="/group/glastonbury/soumick/PRS/simple/initial_external_FreqFilt_simple_S1701_Z49"),
...
if (opt$filtAF == 1){
  ...
  message('[',now,'][Message] filtering sumstats.')
