...
option_list = list(
  ...
  make_option(c('-o', '--output'), action='store', type='character', help='output prefix [required]', default="/group/glastonbury/soumick/PRS/LDPred2/initial_test_basic_FiltAF_S1701_Z49"),
...
# 
# output <- capture.output(paste("R^2:--- cor_PRS_inf: ", cor_PRS_inf, "cor_PRS_grid: ", cor_PRS_grid, "cor_PRS_auto: ", cor_PRS_auto))
